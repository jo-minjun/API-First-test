...
public class Example {
    public static void main(String[] args) {
        ...
        StoreApi apiInstance = new StoreApi(defaultClient);
        OrderDto body = new OrderDto(); // OrderDto | order placed for purchasing the pet
        try {
            OrderDto result = apiInstance.placeOrder(body);
            System.out.println(result);
        } catch (ApiException e) {
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **body** | [**OrderDto**](OrderDto.md)| order placed for purchasing the pet | |
