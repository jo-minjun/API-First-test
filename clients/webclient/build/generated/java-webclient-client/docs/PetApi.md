...
import minjun.openapi.auth.*;
import minjun.openapi.models.*;
import minjun.openapi.api.PetApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        PetDto body = new PetDto(); // PetDto | Pet object that needs to be added to the store
        try {
...
|------------- | ------------- | ------------- | -------------|
| **body** | [**PetDto**](PetDto.md)| Pet object that needs to be added to the store | |
...
> ApiResponseDto uploadFile(petId, additionalMetadata, _file)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ApiResponseDto result = apiInstance.uploadFile(petId, additionalMetadata, _file);
            System.out.println(result);
        } catch (ApiException e) {
