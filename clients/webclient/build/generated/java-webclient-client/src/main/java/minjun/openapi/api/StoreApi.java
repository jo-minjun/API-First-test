...
public class StoreApi {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<OrderDto> getOrderById(Long orderId) throws WebClientResponseException {
        ParameterizedTypeReference<OrderDto> localVarReturnType = new ParameterizedTypeReference<OrderDto>() {};
        return getOrderByIdRequestCreation(orderId).bodyToMono(localVarReturnType);
    }

    public Mono<ResponseEntity<OrderDto>> getOrderByIdWithHttpInfo(Long orderId) throws WebClientResponseException {
        ParameterizedTypeReference<OrderDto> localVarReturnType = new ParameterizedTypeReference<OrderDto>() {};
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    private ResponseSpec placeOrderRequestCreation(OrderDto body) throws WebClientResponseException {
     ...
     * @throws WebClientResponseException if an error occurs while attempting to invoke the API
     */
    public Mono<OrderDto> placeOrder(OrderDto body) throws WebClientResponseException {
        ParameterizedTypeReference<OrderDto> localVarReturnType = new ParameterizedTypeReference<OrderDto>() {};
        return placeOrderRequestCreation(body).bodyToMono(localVarReturnType);
    }

    public Mono<ResponseEntity<OrderDto>> placeOrderWithHttpInfo(OrderDto body) throws WebClientResponseException {
        ParameterizedTypeReference<OrderDto> localVarReturnType = new ParameterizedTypeReference<OrderDto>() {};
