...
public interface PetApi {
    ...
    default ResponseEntity<Void> addPet(
        @Parameter(name = "body", description = "Pet object that needs to be added to the store", required = true) @Valid @RequestBody PetDto body
    ) {
    ...
    default ResponseEntity<List<PetDto>> findPetsByTags(
