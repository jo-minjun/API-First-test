...
import minjun.openapigenerator.api.model.UserDto;
...
public interface UserApiDelegate {
     ...
     */
    default ResponseEntity<Void> createUser(UserDto body) {
     ...
     */
    default ResponseEntity<Void> createUsersWithArrayInput(List<UserDto> body) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
     ...
     */
    default ResponseEntity<Void> createUsersWithListInput(List<UserDto> body) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
